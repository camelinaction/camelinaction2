 ...
 */
public class ControlBusTest extends CamelTestSupport {
    ...
    protected RouteBuilder[] createRouteBuilders() throws Exception {
        ...
        RouteBuilder[] answer = new RouteBuilder[]{new ControlBusRoute(), new RouteBuilder() {
            @Override
    ...
    @Test
    public void testControlBusStop() throws Exception {
