...
public class StickyLoadBalancerTest extends CamelTestSupport {
    ...
    public void testLoadBalancer() throws Exception {
        ...
        // 222 will pick A because its the first message
        // then 333 will be bound to pick B as its the next
        template.sendBodyAndHeader("direct:start", "Hello", "number", 222);
        template.sendBodyAndHeader("direct:start", "Camel rocks", "number", 333);
        template.sendBodyAndHeader("direct:start", "Cool", "number", 333);
        template.sendBodyAndHeader("direct:start", "Bye", "number", 222);
