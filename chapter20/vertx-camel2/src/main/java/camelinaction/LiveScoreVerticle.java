...
public class LiveScoreVerticle extends AbstractVerticle {
    ...
    public void start() throws Exception {
        ...
        // setup vertx-camel bridge
        CamelBridgeOptions camelOptions = new CamelBridgeOptions(camelContext)
            .addInboundMapping(InboundMapping.fromCamel("seda:games").toVertx("games"))
            .addInboundMapping(InboundMapping.fromCamel("seda:clock").toVertx("clock"))
            .addInboundMapping(InboundMapping.fromCamel("seda:goals").toVertx("goals"))
            .addOutboundMapping(OutboundMapping.fromVertx("control").toCamel("seda:control"));
        // create vertx-camel brdige
        camelBridge = CamelBridge.create(vertx, camelOptions);
        // start bridge
        camelBridge.start();
